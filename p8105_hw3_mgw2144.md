...
dataset should include all originally observed variables;and encode data
with reasonable variable classes (i.e. not numeric, and using factors
with the ordering of tables and plots in mind).
